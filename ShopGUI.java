...
public class ShopGUI implements ActionListener
{
    ...
    {
        ShopGUI aGadgetShop=new ShopGUI() ;
    }
    ...
    private void makeFrame()
    {
        ...
        makeACall.setForeground(Color.black);
        makeACall.setBackground(Color.cyan);
        addMobileButton.setForeground(Color.black);
        addMobileButton.setBackground(Color.cyan);
        addMP3Button.setForeground(Color.black);
        addMP3Button.setBackground(Color.cyan);
